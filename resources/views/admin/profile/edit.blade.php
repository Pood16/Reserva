                    ...
                    <div class="p-6">
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="w-20 h-20 rounded-full overflow-hidden mr-4">
                                        ...
                                        @else
                                            <div class="w-full h-full flex items-center justify-center bg-blue-100 rounded-full text-blue-800 text-2xl">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-2">To change your password, please use the <a href="{{ route('admin.profile.password.edit') }}" class="text-blue-600 hover:underline">change password</a> form.</p>
                            </div>

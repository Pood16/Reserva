    ...
    <div class="w-full bg-gray-50 py-20">
        <div class="flex flex-col md:flex-row w-11/12 max-w-5xl mx-auto rounded-lg overflow-hidden shadow-[0px_5px_14px_0px_rgba(8,15,52,0.04)]">
            ...
            <div class="hidden md:block md:w-1/2 bg-amber-50">
                <img src="{{asset('resources/images/register.jpg')}}" alt="Restaurant ambiance" class="w-full h-full object-cover" />
            </div>

            <!-- Registration Form -->
            <div class="w-full md:w-1/2 bg-white px-8 py-10">
                <h2 class="text-center text-2xl font-semibold text-gray-900 mb-2">Join Our Table</h2>
                <p class="text-center text-gray-600 text-sm mb-8">Create your account to start making reservations</p>
